...
export function SignIn() {
	return (
		<div className="flex flex-col gap-2 p-8">
			...
			<Button
				className="inline-flex w-48 items-center rounded border border-neutral-200 bg-[#5468ff] p-1 px-3 py-2 text-sm font-medium leading-4 text-neutral-900 dark:border-neutral-700"
